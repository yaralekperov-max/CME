...
const updateCourseSchema = z.object({
  ...
  format: z.enum(['ONLINE', 'IN_PERSON', 'BLENDED', 'WEBINAR', 'CONFERENCE']).optional(),
  typicalProgramOrder: z.string().optional(),
  typicalProgramTitle: z.string().optional(),
  inPersonCity: z.string().optional(),
